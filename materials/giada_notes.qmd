...
Nota: Gli smooth terms specificati via `s()` sono appropriati sia come effetti principali da soli che come effetti principali eventualmente combinati con interazioni di tipo Tensor Product: s(x) + s(z) + ti(x, z) (vedi dopo).
